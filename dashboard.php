          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php
                    ...
                    ?>
                <CENTER><h3 class="page-header" >Count Per Upload of File  </h3></CENTER>  
  ...
  <script>
    ...
    var myChart = new Chart(ctx, {
     ...
     data: {
            ...
            datasets: [{
                      backgroundColor: ["#030748", "#030748", "#030748", "#fff", "#4D5360", "#6ae27e", "#dc69e2", "#687be2", "#e28868", "#6c68e2", "#ab68e2", "#e268b7"],
    ...
    var myPieChart = new Chart(ctxP, {
      type: 'pie',
      data: {
        labels: ["dark blue", "Green", "Yellow", "Grey", "Dark Grey"],
        datasets: [{
          data: [300, 50, 100, 40, 120],
          backgroundColor: ["#030748", "#46BFBD", "#FDB45C", "#949FB1", "#4D5360"],
          hoverBackgroundColor: ["#030748", "#5AD3D1", "#FFC870", "#A8B3C5", "#616774"]
        }]
      },
      options: {
        responsive: true,
